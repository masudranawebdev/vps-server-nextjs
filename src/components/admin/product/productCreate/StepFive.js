...
const StepFive = ({
  ...
  const localStaorageJananiStepFiveData =
    typeof window !== "undefined"
      ...
      : null;
  const jananiStepFiveDatas = localStaorageJananiStepFiveData
    ? JSON.parse(localStaorageJananiStepFiveData)
    : {};
  const [jananiStepFiveData, setjananiStepFiveData] =
    useState(jananiStepFiveDatas);
  ...
  const [product_key_feature, setProduct_key_feature] = useState(
    jananiStepFiveData?.product_key_feature
      ? jananiStepFiveData?.product_key_feature
      : ""
  );
  const [product_description, setProduct_description] = useState(
    jananiStepFiveData?.product_description
      ? jananiStepFiveData?.product_description
      : ""
  );
  ...
  const [keywords, setKeywords] = useState(
    jananiStepFiveData
      ? jananiStepFiveData?.meta_keywords
        ? jananiStepFiveData?.meta_keywords
        : []
      : []
  );
  ...
  // handle hot deal
  const handleHotDealChange = () => {
    setjananiStepFiveData((prevState) => ({
      ...prevState,
  ...
  const handleDataPost = (data) => {
    ...
    const alldataString = JSON.stringify(sendData);
    localStorage.setItem("jananiStepFiveData", alldataString);
  ...
  return (
    <>
      <form onSubmit={handleSubmit(handleDataPost)} className="mt-3">
        <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
          <div>
            ...
            <input
              defaultValue={jananiStepFiveData?.product_warranty}
          ...
          <div>
            ...
            <input
              defaultValue={jananiStepFiveData?.product_EMI_price}
          ...
          <div>
            ...
            <input
              defaultValue={jananiStepFiveData?.product_EMI_month}
        ...
        <div className="grid md:grid-cols-3 grid-cols-1 gap-4 mt-4">
          ...
          <div>
            ...
            <input
              defaultValue={jananiStepFiveData?.product_gift}
        ...
        <div className="mt-4 flex items-center gap-2">
          <input
            ...
            type="checkbox"
            className="w-5 h-5"
            checked={jananiStepFiveData?.product_hot_deal}
            onChange={handleHotDealChange} // Call handleHotDealChange when the checkbox is clicked
          />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mt-4 flex items-center gap-2">
            <input
              ...
              type="checkbox"
              className="w-5 h-5"
              checked={jananiStepFiveData?.product_pc_builder}
          ...
          {jananiStepFiveData?.product_pc_builder == true && (
            <div>
        ...
        <div className="mt-4">
          ...
          <input
            defaultValue={jananiStepFiveData?.meta_title}
            {...register("meta_title")}
            id="meta_title"
            type="text"
            className="block w-full px-2 py-2 text-gray-700 bg-white border border-gray-200 rounded-xl mt-2"
        ...
        <div className="mt-4">
          ...
          <textarea
            cols={5}
            defaultValue={jananiStepFiveData?.meta_description}
      ...
      {openPublishProductModal && (
        <ConfirmModal setOpenPublishProductModal={setOpenPublishProductModal} />
      )}
    </>
  );
};
